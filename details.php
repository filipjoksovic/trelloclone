                            ...
                            <div class="my-2 row align-items-center justify-content-between">
                                ...
                                <div class="col-md-3 text-center">
                                    ...
                                    <form action = "app.php" method = "POST">
                                        ...
                                        <button type = "submit" class = "btn btn-primary"><?php echo Engine::getStatusName($activity['status_id']);?><br>-><?php echo Engine::getStatusName($activity['status_id'] + 1);?></button>
                                    </form>
                                    <?php else:?>
                                        <button disabled class = "btn btn-success"><?php echo Engine::getStatusName($activity['status_id']);?></button>
